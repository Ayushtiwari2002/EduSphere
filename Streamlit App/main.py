...
st.set_page_config(page_title='TeacherStudentDistributionAnalyser')
...
def main():
    ...
    st.sidebar.warning(
            """
            Teacher Student Distribution Analyser app is created and maintained by **Ayush Kumar Tiwari**. 
